...
export function SignInScreen({ onBack, onSubmit }) {
  ...
  const handleSignIn = async () => {
    // Import login helper at the top of the file if not already imported
    const { login } = require('./Tokenutils');
    ...
    try {
      ...
      // Use the login helper which handles everything
  ...
  return (
    <SafeAreaView style={styles.authScreenContainer}>
      ...
      <View style={styles.authFormContainer}>
        ...
        <TouchableOpacity
          style={[styles.primaryAuthButton, loading && styles.buttonDisabled]}
